  ...
  return (
    <section className="pt-32 pb-20 px-4 md:px-8 max-w-[1400px] mx-auto">
          ...
          <div className="flex-1">
            <div className="flex flex-col">
              <motion.h2 
                ...
                className="text-[100px] md:text-[140px] leading-[0.9] font-[700] tracking-[-0.06em] uppercase text-black"
              >
                WELCOME TO
              </motion.h2>
              <motion.h1 
      ...
      <motion.div 
        ...
        className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mt-24 border-t border-black/10 pt-8"
      >
        ...
        <div className="md:col-span-8">
            <p className="text-[24px] md:text-[28px] leading-[1.3] font-normal tracking-tight max-w-[500px] text-balance">
            Welcome to the Lab. International professional experience meets cutting-edge development. 
            Yusuf Shahata brings elite-level detail to players of all levels. Game-real reps. 
